...
%COVERAGE3% -m unittest discover > tests.txt
...
%COVERAGE3% -a algs\timing.py > algs.txt
%COVERAGE3% -a ch02\timing.py > ch02.txt
%COVERAGE3% -a ch03\timing.py > ch03.txt
%COVERAGE3% -a ch04\timing.py > ch04.txt
%COVERAGE3% -a ch05\timing.py > ch05.txt
%COVERAGE3% -a ch06\timing.py > ch06.txt
%COVERAGE3% -a ch07\timing.py > ch07.txt
