...
from ch01.largest import largest, alternate, just_three
...
from ch01.challenge import linear_median, is_palindrome_letters_only
...
class Test_Ch01(unittest.TestCase):
    ...
    def test_just_three(self):
        ...
        self.assertEqual(3, just_three([2, 3, 3]))
